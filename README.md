...
- License: **AGPL-3.0-or-later for now** (Swiss Ephemeris via `sweph-wasm` is AGPL). Target: proprietary once an in-house ephemeris supersedes Swiss Ephemeris (D9). Public repo either way.
